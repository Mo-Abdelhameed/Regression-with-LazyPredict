...
- **Description**: A list of regressor names that will be used for the modeling process. The names should correspond to the respective scikit-learn regressor class names.
